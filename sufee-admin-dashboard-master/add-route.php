...
$sql .= "(routeNumber,busNumber,source,destination,arrivalTime,departTime,is_available_Saturday)";
$sql .= "VALUES ";
$sql .= "(";
$sql .= "'" . $newroute["rno"] . "', ";
$sql .= "'" . $newroute["bno"] . "', ";
$sql .= "'" . $newroute["src"] . "', ";
$sql .= "'" . $newroute["dest"] . "', ";
$sql .= "'" . $newroute["arrTime"] . "', ";
$sql .= "'" . $newroute["deptTime"] . "', ";
$sql .= "'" . $newroute["is_available_Sat"] . "'";
$sql .= ")";
        ...
        <nav class="navbar navbar-expand-sm navbar-default">
            ...
            <div id="main-menu" class="main-menu collapse navbar-collapse">
                <ul class="nav navbar-nav">
                    ...
                    <li class="menu-item-has-children dropdown">
                        <a href="#"> <i class="menu-icon fa fa-laptop"></i>Add a Route</a>
                    </li>
                    ...
                    <div class="card">
                      ...
                      <div class="card-body card-block">
                        <form action = "add-route.php" method="POST" >
                            <div class="form-group"><label for="Route Number" class=" form-control-label">Route Number</label><input type="text" name="routeNumber"  class="form-control"></div>
                            <div class="form-group"><label for="Bus Number" class=" form-control-label">Bus Number</label><input type="text" name="busNumber"  class="form-control"></div>
                            <div class = "row">
                              <div class="col-lg-6">
                            ...
                            <div class = "row">
                              <div class="col-lg-6">
                                <div class="form-group"><label for="Arrival Time" class=" form-control-label">Arrival Time</label><input type="text" name="arrivalTime"  class="form-control"></div>
                              </div>
                              <div class="col-lg-6">
                                <div class="form-group"><label for="Depart Time" class=" form-control-label">Departure Time</label><input type="text" name="departTime" class="form-control"></div>
                              </div>
                            </div>
                            
                            <div class="form-group"><label for="SaturdayAvailable" class=" form-control-label">Saturday Availability</label><input type="text" name="is_available_Saturday"  class="form-control"></div>
                            <p>
